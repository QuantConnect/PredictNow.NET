...
public class ModelParameters
{
    ...
    /// Define custom weights
    /// </summary>
    [JsonProperty(PropertyName = "pre_engg_features_list")]
    public string[] FeaturesList { get; private set; } = ["ALL"];
    ...
    /// <param name="featuresList">List of feature: ['TR', 'CANARY', 'NOPE', 'OF'] or ['ALL']</param>
    /// <param name="customWeights">Define custom weights</param>
    /// <param name="randomSeed">Random seed for initialization</param>
    public ModelParameters(Mode mode, ModelType type, FeatureSelection featureSelection, Analysis analysis, Boost boost, double testsize, bool timeseries, bool probabilityCalibration, bool exploratoryDataAnalysis, string weights, string[] featuresList = null, string customWeights= "", double randomSeed = 1)
    {
        Mode = mode;
        Type = type;
